...
void setupVertexBuffer(unsigned int &VBO, unsigned int &VAO, unsigned int &EBO) {
...
void draw(int compressedTexture, int VAO, Shader &ourShader) {
    // render
    // ------
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        draw(compressedTexture, VAO, ourShader);
